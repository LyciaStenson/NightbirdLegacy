...
int main()
{
	...
	//engine.GetResourceManager().InstantiateModel(engine.m_World, "WitchCabin", glm::vec3(0.0f, 0.0f, -2.5f), glm::quat(glm::vec3(glm::radians(0.0f), glm::radians(0.0f), glm::radians(0.0f))), glm::vec3(1.0f, 1.0f, 1.0f))
		//.set<SpinComponent>({ 0.1f, glm::vec3(0.0f, 1.0f, 0.0f) });
